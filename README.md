...
평소에 아날로그 뽀모도로 타이머를 쓰고 있었는데, 사용하면서 아쉬웠던 부분들을 디지털로만 가능한 기능을 추가하는 방식으로 보완하여 만들어봄
...
<table>
  <tr>
    <td><img src="readme_files/Pomodoro_calendar_color.png" width="30"/></td>
    <td>
...
> PS: Room Database 처음 써봐서 데이터 저장하는 부분이 제일 어려웠고, 시간대 문제로 날짜가 하루 밀려서 저장되는 버그도 있었음.
